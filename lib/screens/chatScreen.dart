...
class ChatScreen extends StatelessWidget{
  const ChatScreen({Key? key,required this.useremail,required this.title,required this.id,required this.username}) : super(key: key);
    ...
    print('chatscreen');
     return Scaffold(
       ...
       body: Container(
         ...
         child: Column(
           children: [
             Expanded(child:Messeges(id: id, user_email: useremail)),
             NewMesseges()
