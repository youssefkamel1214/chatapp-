...
class Authprovider extends GetxController {
  ...
  Future<bool> submitAuthForm(String email, String password, String user_name,
    ...
    try {
      ...
      if (e.message!.contains('password'))
        ...
        Fluttertoast.showToast(
            msg: e.message!, toastLength: Toast.LENGTH_SHORT);
      }
      isloading.update((val) {
        isloading.value = false;
      });
      ...
      Fluttertoast.showToast(msg: 'sorry there was error try again later');
      return false;
    } catch (e) {
